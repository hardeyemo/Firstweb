...
const Contact = () => {
  return (
    <div>
        <Nav />
        <div className="max-w-8xl mx-auto px-6 py-16 space-y-12 bg-gray-50">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 md:flex md:space-x-8">
        <form className="w-full space-y-6 md:w-2/3">
          ...
          <button
            type="submit"
            className="bg-blue-500 text-white font-semibold rounded-md px-6 py-3 w-full hover:bg-blue-600 transition-colors duration-300"
          >
            Send Message
          </button>
        </form>
      ...
      <div className="text-center space-y-4">
        <p className="text-gray-600">
          ...
          <a href="mailto:contact@ourmusicblog.com" className="text-blue-500 underline">
        ...
        <div className="flex justify-center space-x-6 text-gray-600 text-2xl">
          ...
          <a href="#" aria-label="LinkedIn" className="hover:text-blue-600 transition-colors duration-300">
