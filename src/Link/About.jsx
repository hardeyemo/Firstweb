...
import authorImage from '../assets/1739904662097.jpeg';
import pattern from '../assets/hunterwasser.jpg';
  ...
  return (
    <div>
      <div className="max-w-8xl mx-auto px-6 py-12 space-y-16 bg-gray-50 mt-7">
        <div className="relative h-96 bg-cover bg-center rounded-lg overflow-hidden shadow-md" style={{ backgroundImage: `url(${pattern})` }}>
        ...
        <div className="bg-white rounded-lg p-8 shadow-lg space-y-4 hover:shadow-2xl transition-shadow duration-300">
          ...
          <p className="text-gray-600 text-lg text-center max-w-3xl mx-auto leading-relaxed">
            This platform was created to bring together photo lovers and storytellers. Every image shared holds a unique story and you have the chance to title it and make it part of your own memory. It’s about expression, creativity, and community.
          </p>
        </div>
